...
#+BEGIN_SRC emacs-lisp
(org-add-agenda-custom-command
   '("j" "Journal articles" tags-todo "+paper"
     ((org-agenda-prefix-format " %i %-8:c%(josh/org-show-effort-and-clocked) ")
...
Note: Actually, this doesn't seem to be necessary. You can use
~pdf-history-forward~ and ~pdf-history-backward~, which are bound to
